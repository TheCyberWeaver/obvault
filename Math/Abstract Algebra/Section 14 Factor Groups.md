...
We first divide $G$ into several partitions or formally _cosets_ (written in the form $gH$ with $g\in G$, presenting $\{ g\cdot h| h\in H \}$). 
Each partition has "size" $\lvert H \rvert$, and the set of all cosets forms a new group denoted as $G/H$.
This group $G/H$ has 
- Identity: $H$
- Inverse:$(gH)^{-1}=g^{-1}H$
...
> [!Tip]
> H can also be any [[Section 13 Homomorphisms#13.19 Definition normal|normal subgroup]] subgroup of $G$, otherwise we cannot form a factor group
...
$$(aH)(bH)=(ab)H$$
This is **well defined**(independent from the choice of $h\in H$) if and only if H is a [[Section 13 Homomorphisms#13.19 Definition normal|normal subgroup]] of G
