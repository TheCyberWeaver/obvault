...
| ------- | -------------------------------------------------------------------- | ---------------------- | --------------------------- |
| Set     | Equivalence relation                                                 | Partition ( $S/\sim$ ) | [[Coequalizer]] in **Set**  |
| Group   | Normal subgroup ( $N$ )<br>$a\sim b\Longleftrightarrow a^{-1}b\in N$ | Factor group ( $G/N$ ) | [[Coequalizer]] in **Grp**  |
| Ring    | Ideal ( $I$ )<br>$a\sim b\Longleftrightarrow a-b\in I$               | Factor ring ( $R/I$ )  | [[Coequalizer]] in **Ring** |
