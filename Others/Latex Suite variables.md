{
	...
	"${MORE_SYMBOLS}": "leq|geq|neq|gg|ll|equiv|sim|propto|rightarrow|leftarrow|Rightarrow|Leftarrow|leftrightarrow|longleftrightarrow|to|mapsto|cap|cup|sqcap|bigcap|sqcup|bigcup|in|sum|prod|exp|ln|log|det|dots|vdots|ddots|pm|mp|int|iint|iiint|oint|cong|preceq|prec|preccurlyeq|varnothing|top|hookrightarrow|models|coprod|Longleftrightarrow"
}
